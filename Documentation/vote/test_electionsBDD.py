...
class TestElection(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.presid = Election("Élections présidentielles", (ouverture, cloture), "electionTest", "CONDORCET")
        self.presid2 = Election("Élections présidentielles", (cloture, ouverture), "electionTest", "JUGEMENT MAJORITAIRE")
    ...
    def testRemplissage(self):
        ...
        vote.completeBulletin("Macron", 1)
        vote.completeBulletin("Le Pen", 2)
        vote.completeBulletin("Mélenchon", 3)
